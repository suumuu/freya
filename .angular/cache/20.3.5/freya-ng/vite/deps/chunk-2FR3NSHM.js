import {
  Checkbox
} from "./chunk-ZLLY7HB4.js";
import {
  InputIcon
} from "./chunk-KEEJDCFV.js";
import {
  IconField
} from "./chunk-GLJMYVYK.js";
import {
  Scroller
} from "./chunk-FZQB5UMU.js";
import {
  InputText
...
function UITreeNode_Conditional_0_ng_container_4_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, UITreeNode_Conditional_0_ng_container_4_ng_container_1_Template, 3, 2, "ng-container", 6)(2, UITreeNode_Conditional_0_ng_container_4_ng_container_2_Template, 2, 2, "ng-container", 6);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext(2);
...
function UITreeNode_Conditional_0_span_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵclassMap(ctx_r1.cx("nodeToggleIcon"));
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", ctx_r1.tree.togglerIconTemplate || ctx_r1.tree._togglerIconTemplate)("ngTemplateOutletContext", ɵɵpureFunction2(4, _c1, ctx_r1.node.expanded, ctx_r1.node.loading));
  }
}
...
function UITreeNode_Conditional_0_ul_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, UITreeNode_Conditional_0_ul_12_p_treeNode_1_Template, 1, 8, "p-treeNode", 18);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext(2);
...
function UITreeNode_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵconditionalCreate(1, UITreeNode_Conditional_0_Conditional_1_Template, 1, 3, "div", 3);
    ...
    ɵɵtemplate(4, UITreeNode_Conditional_0_ng_container_4_Template, 3, 2, "ng-container", 6)(5, UITreeNode_Conditional_0_span_5_Template, 2, 7, "span", 7);
    ɵɵelementEnd();
    ɵɵtemplate(6, UITreeNode_Conditional_0_p_checkbox_6_Template, 2, 9, "p-checkbox", 8)(7, UITreeNode_Conditional_0_span_7_Template, 1, 2, "span", 7);
    ...
    ɵɵelementEnd()();
    ɵɵconditionalCreate(11, UITreeNode_Conditional_0_Conditional_11_Template, 1, 3, "div", 3);
    ɵɵtemplate(12, UITreeNode_Conditional_0_ul_12_Template, 2, 4, "ul", 9);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
    ...
    ɵɵproperty("ngStyle", ɵɵpureFunction1(33, _c0, ctx_r1.itemSize + "px"));
    ...
    ɵɵproperty("draggable", ctx_r1.tree.draggableNodes);
    ɵɵadvance();
...
var UITreeNode = class _UITreeNode extends BaseComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 1,
    vars: 1,
    consts: [["icon", ""], ["role", "treeitem", 3, "class", "ngStyle", "style"], ["role", "treeitem", 3, "keydown", "ngStyle"], [3, "class"], [3, "click", "contextmenu", "dblclick", "touchend", "drop", "dragstart", "dragover", "dragleave", "dragend", "draggable"], ["type", "button", "pRipple", "", "tabindex", "-1", 3, "click"], [4, "ngIf"], [3, "class", 4, "ngIf"], [3, "ngModel", "styleClass", "binary", "indeterminate", "disabled", "variant", "tabindex", "click", 4, "ngIf"], ["role", "group", 3, "class", 4, "ngIf"], ["data-p-icon", "chevron-right", 3, "class", 4, "ngIf"], ["data-p-icon", "chevron-down", 3, "class", 4, "ngIf"], ["data-p-icon", "chevron-right"], ["data-p-icon", "chevron-down"], ["data-p-icon", "spinner", "spin", ""], [4, "ngTemplateOutlet", "ngTemplateOutletContext"], [3, "click", "ngModel", "styleClass", "binary", "indeterminate", "disabled", "variant", "tabindex"], ["role", "group"], [3, "node", "parentNode", "firstChild", "lastChild", "index", "itemSize", "level", "loadingMode", 4, "ngFor", "ngForOf", "ngForTrackBy"], [3, "node", "parentNode", "firstChild", "lastChild", "index", "itemSize", "level", "loadingMode"]],
    template: function UITreeNode_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵconditionalCreate(0, UITreeNode_Conditional_0_Template, 13, 35, "li", 1);
      }
      if (rf & 2) {
...
//# sourceMappingURL=chunk-2FR3NSHM.js.map
