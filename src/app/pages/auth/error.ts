...
@Component({
    ...
    template: `<app-configurator [simple]="true" />
        <div>
            <div class="flex items-center py-0 w-full z-20 px-8" style="height: 62px; box-shadow: 0 10px 40px 0 rgb(41 50 65 / 6%); background: var(--surface-card)">
                <a id="logolink" [routerLink]="['/']" style="cursor: pointer">
            ...
            <div class="flex flex-col justify-center items-center" style="min-height: calc(100vh - 62px)">
                <div class="flex flex-col justify-center">
                    <img src="/demo/images/pages/asset-error.svg" alt="freya-layout" style="width: 332px; height: 271px" />
                    <span class="block text-7xl text-center">Error</span>
                </div>
                <div class="flex items-center pt-20">
                    <span class="text-2xl font-semibold m-0 mr-8">freya</span>
                    <span class="m-0 mt-1 text-surface-300 dark:text-surface-500 font-medium">Copyright Ⓒ PrimeTek Informatics</span>
                </div>
            </div>
        </div>`
})
