...
declare class UITreeNode extends BaseComponent implements OnInit {
    ...
    tree: Tree;
    timeout: any;
    isPrevDropPointHovered: i0.WritableSignal<boolean>;
    isNextDropPointHovered: i0.WritableSignal<boolean>;
    isNodeDropHovered: i0.WritableSignal<boolean>;
    isPrevDropPointActive: i0.Signal<boolean | undefined>;
    isNextDropPointActive: i0.Signal<boolean | undefined>;
    isNodeDropActive: i0.Signal<boolean | undefined>;
    dropPosition: i0.Signal<1 | -1 | 0>;
