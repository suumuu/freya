...
declare class Badge extends BaseComponent {
     ...
     * @group Props
     */
    badgeSize: i0.InputSignal<"small" | "large" | "xlarge" | null | undefined>;
    /**
     * Size of the badge, valid options are "large" and "xlarge".
     * @group Props
     */
    size: i0.InputSignal<"small" | "large" | "xlarge" | null | undefined>;
    /**
     * Severity type of the badge.
     * @group Props
     */
     ...
     * @group Props
     */
    value: i0.InputSignal<string | number | null | undefined>;
    /**
     * When specified, disables the component.
     * @group Props
     */
